...
!!! note
    从 `2.0.0` 版本开始，gitstats 使用 [Chart.js](https://www.chartjs.org/)（随报告捆绑）来渲染图表，以实现更现代的可视化效果和更好的性能。

## 安装

使用 [pip](https://pip.pypa.io/en/stable/) 安装 [gitstats](https://pypi.org/project/gitstats/)：
...
!!! tip
    你也可以使用 [uv](https://docs.astral.sh/uv/) 一条命令下载并运行 gitstats：
...
查看在线示例：<https://shenxianpeng.github.io/gitstats/report/index.html>
...
!!! tip
    使用 [jq](https://jqlang.github.io/jq/) 解析 JSON 文件：
...
更多配置选项，请参阅[配置](configuration.md)页面。
