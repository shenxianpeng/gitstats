...
Run `gitstats --help` for more options, or check the [Getting Started](getting-started.md) guide.
...
For detailed setup instructions, configuration options, and examples, see the [AI Integration](ai-integration.md) page.
