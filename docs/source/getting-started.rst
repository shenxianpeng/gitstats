...
.. note::
    ...
    Starting from version ``1.0.0``, gitstats uses `gnuplot-wheel <https://pypi.org/project/gnuplot-wheel/>`_ package which bundles gnuplot as a Python dependency. You no longer need to install gnuplot separately!
