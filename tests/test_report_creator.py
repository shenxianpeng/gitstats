...
import gitstats.report_creator as report_creator
...
class TestHTMLReportCreator:
    ...
    def test_create_copies_static_files(self, mock_dirname, mock_exists, mock_copy, temp_dir):
        ...
        with patch.object(creator, 'create_index_html'), \
    ...
    def test_create_index_html(
        ...
        with patch.object(creator, 'print_header'), \
...
def test_create_activity_html_no_first_commit(mock_pipe, mock_file, temp_dir):
    ...
    mock_data.commits_by_timezone = {"+0000": 1}  # Need at least one to avoid max() error
