...
📘 文档：[shenxianpeng.github.io/gitstats/docs](https://shenxianpeng.github.io/gitstats/docs/)
...
运行 `gitstats --help` 查看更多选项，或查阅[文档](https://shenxianpeng.github.io/gitstats/docs/)。
...
详细的安装说明、配置选项和示例，请参阅 [AI 集成文档](https://shenxianpeng.github.io/gitstats/docs/ai-integration/)。
